...
class GcfDdFunctionServiceTest {
    ...
    public void Should_successfully_save_exp_record_from_zero_write_function_call() {
        ...
        String expectedCommand = "if=/dev/zero of=/tmp/file1 bs=512 count=250000";
    ...
    public void Should_successfully_save_exp_record_from_urandom_direct_write_function_call() {
        ...
        DdExperimentEntity savedEntity = gcfDdFunctionService.collectURandomDirectWriteExpRecord(ioSizeTier, fileSizeTier);
        assertEquals(expectedExperiment, savedEntity);
    }
    ...
    public void Should_successfully_save_exp_record_from_read_function_call() {
        ...
        DdExperimentEntity savedEntity = gcfDdFunctionService.collectCachedReadExpRecord(ioSizeTier, fileSizeTier);
        assertEquals(expectedExperiment, savedEntity);
    }
    ...
    public void Should_successfully_save_exp_record_from_urandom_write_function_call() {
        ...
        IoSizeTier ioSizeTier = IoSizeTier.TIER_1;
        FileSizeTier fileSizeTier = FileSizeTier.TIER_5;
        String expectedCommand = "if=/dev/urandom of=/tmp/file1 bs=512 count=250000";
        CommandRequest commandRequest = new CommandRequest(expectedCommand);
        DdExperimentEntity expectedExperiment = new DdExperimentEntity();
    ...
    public void Should_successfully_save_exp_record_from_urandom_write_function_call_converting_iosize_to_KB() {
        ...
        IoSizeTier ioSizeTier = IoSizeTier.TIER_2;
        FileSizeTier fileSizeTier = FileSizeTier.TIER_5;
        String expectedCommand = "if=/dev/urandom of=/tmp/file1 bs=1k count=128000";
        CommandRequest commandRequest = new CommandRequest(expectedCommand);
        DdExperimentEntity expectedExperiment = new DdExperimentEntity();
